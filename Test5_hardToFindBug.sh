...
python3 main.py --pre test/sha256/pre --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm1 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""
...
python3 main.py --pre test/sha256/pre --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm3 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #3${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~22 minutes${normal}"
python3 main.py --pre test/sha256/pre --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm4 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #4${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~30 minutes${normal}"
python3 main.py --pre test/sha256/diffInst/pre5 --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm5 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #5${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~29 minutes${normal}"
python3 main.py --pre test/sha256/pre --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm6 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #6${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~23 minutes${normal}"
python3 main.py --pre test/sha256/pre --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm7 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #7${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~22 minutes${normal}"
python3 main.py --pre test/sha256/pre --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm8 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #8${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~34 minutes${normal}"
python3 main.py --pre test/sha256/pre --post test/sha256/post --p1 test/sha256/dsl --p1lang dsl --p2 test/sha256/diffInst/asm9 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #9${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~60 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm1 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #10${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~47 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm3 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #11${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: Concrete Execution)${normal}"
echo "${bold}Expected Required Time: ~2 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm8 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #12${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~31 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm9 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #13${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~52 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm10 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #14${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: Concrete Execution)${normal}"
echo "${bold}Expected Required Time: ~2 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm11 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #15${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~30 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm12 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #16${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~52 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm13 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""

echo "${bold}Hard to Detect Bug #17${normal}"
echo "${bold}Expected result: p1 is not equivalent to p2 (Reason: SMT Timeout)${normal}"
echo "${bold}Expected Required Time: ~45 minutes${normal}"
python3 main.py --pre test/sha256_ssse3/pre --post test/sha256_ssse3/post --p1 test/sha256_ssse3/dsl --p1lang dsl --p2 test/sha256_ssse3/diffInst/asm14 --p2lang asm --arch x86_64  --verif_mode hybrid
echo ""
