#2 rounds of SHA256
echo "BENCHMARK: Verifying 2 rounds of SHA256"
...
#A small part of AES128 key expansion for decryption algorithm
echo "BENCHMARK: Verifying permutation algorithm in AES key expansion"
echo "Expected result: Equivalent (Time: )"
python3 main.py --pre test/AES_dec_key_permute/pre --post test/AES_dec_key_permute/post --p1 test/AES_dec_key_permute/dsl --p1lang dsl --p2 test/AES_dec_key_permute/asm --p2lang asm  --verif_mode hybrid --mem_model 8
