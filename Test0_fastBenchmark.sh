...
echo "Expected result: Equivalent (Expected Time: ~5 seconds)"
...
echo "Expected result: Equivalent (Expected Time: ~ 5 minutes)"
...
echo "Expected result: Equivalent (Expected Time: ~ 15 minutes)"
...
#AES_encrypt
echo "Expected result: Equivalent (Expected Time: ~ 17 minutes)"
